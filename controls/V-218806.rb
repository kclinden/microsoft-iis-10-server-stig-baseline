...
control 'V-218806' do
  title "The IIS 10.0 web server must augment re-creation to a stable and known
baseline."
...
for the IIS 10.0 web server in the event of the necessity for rollback.

    If documentation for a disaster recovery has not been established, this is
a finding.
  "
  desc  'fix', "
    Prepare documentation for disaster recovery methods for the IIS 10.0 web
