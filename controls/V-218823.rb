...
control 'V-218823' do
  title "All accounts installed with the IIS 10.0 web server software and tools
...
need to have passwords set or changed.
  ...
  desc  'check', "
    ...
    Access the \"Apps\" menu. Under \"Administrative Tools\", select \"Computer
Management\".
    ...
    If any local accounts are present and used by IIS 10.0, verify with System
...
Management.
    ...
    Change passwords for any local accounts present that are used by IIS 10.0,
then verify with System Administrator default passwords have been changed.
