...
control 'V-218817' do
  title "The IIS 10.0 web server must not be running on a system providing any
other role."
...
network-related services deemed non-essential to the server mission, are too
unsecure, or are prohibited by the PPSM CAL and vulnerability assessments.
  "
  desc  'rationale', ''
  desc  'check', "
    ...
    The following programs may be installed without any additional
documentation:
...
those listed above, this is a finding.

    Note: If additional software is needed and has supporting documentation
signed by the ISSO, this is not a finding.
  "
