...
control 'V-218805' do
  title "The IIS 10.0 web server must accept only system-generated session
identifiers."
...
the \"Mode:\" drop-down list.
    ...
    If the \"Use Cookies” mode is selected and Time-out (in minutes) is
configured for “20 minutes or less”, this is not a finding.
...
specific system IPs, this is Not Applicable.
  ...
  desc  'fix', "
    ...
    Under \"Cookie Settings\", select the \"Use Cookies\" mode from the
\"Mode:\" drop-down list.
